...
/////////////////
const BotName = 'FlaxEVex BotZ'; 
const instagram = 'https://instagram.com/daffa0782'; 
const telegram = 'https://t.me/Daffa0234'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCX4_VcnyJAM4GHy4Kf6dhtg';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@daffa0782')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@daffa0728`)
})
